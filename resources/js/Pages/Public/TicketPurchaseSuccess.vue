  ...
  <div class="min-h-screen bg-gray-50 py-12">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <div class="text-center">
        ...
        <!-- Success Message -->
        <div class="mb-8">
          <h1 class="text-3xl font-bold text-gray-900">Ticket Purchase Successful!</h1>
          <p class="mt-4 text-lg text-gray-600">
            Your ticket has been purchased and confirmed. A confirmation email will be sent to your registered email address.
          </p>
        </div>

        <!-- Ticket Details -->
        <div v-if="ticket" class="bg-white rounded-lg shadow-md overflow-hidden">
          <div class="p-8">
            ...
            <div class="space-y-4">
              ...
              <div class="flex justify-between border-b pb-4">
                ...
                <span class="font-medium text-gray-900">{{ ticket.guest_name }}</span>
              </div>
              
              <div class="flex justify-between border-b pb-4">
                <span class="text-gray-600">Email:</span>
                <span class="font-medium text-gray-900">{{ ticket.guest_email }}</span>
              </div>
              
              <div class="flex justify-between border-b pb-4">
                <span class="text-gray-600">Phone:</span>
                <span class="font-medium text-gray-900">{{ ticket.guest_phone || 'Not provided' }}</span>
              </div>
              ...
              <div class="flex justify-between border-b pb-4">
                ...
                <span class="font-medium text-gray-900">{{ ticket.formatted_amount }}</span>
              </div>
              
              <div class="flex justify-between border-b pb-4">
                <span class="text-gray-600">Purchase Date:</span>
                <span class="font-medium text-gray-900">{{ ticket.formatted_purchase_date }}</span>
              </div>
              
              <div class="flex justify-between pb-4">
                <span class="text-gray-600">Status:</span>
                <span class="font-medium" :class="ticket.payment_status === 'paid' ? 'text-green-600' : 'text-yellow-600'">
            ...
            <!-- QR Code -->
            <div v-if="ticket.qr_code" class="text-center mt-8">
              <div class="text-sm text-gray-600 mb-4">Your QR Code</div>
        ...
        <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a :href="`mailto:${ticket.guest_email}`" 
