    ...
    <div class="space-y-6">
      ...
      <div class="overflow-hidden rounded-lg bg-white shadow-sm dark:bg-slate-900">
        ...
        <div class="space-y-6 p-6">
          ...
          <div class="mt-6 border-t-2 border-slate-200 pt-6 dark:border-slate-700">
            <div class="space-y-2">
              <div class="flex justify-between py-2">
                <span class="text-lg font-semibold text-slate-700 dark:text-slate-300">Total Revenue</span>
                <span class="text-lg font-semibold text-green-600 dark:text-green-400">
                  ₦{{ formatNumber(report.totals.revenue) }}
                </span>
              </div>
              <div class="flex justify-between py-2">
                <span class="text-lg font-semibold text-slate-700 dark:text-slate-300">Total Expenses</span>
                <span class="text-lg font-semibold text-red-600 dark:text-red-400">
                  ₦{{ formatNumber(report.totals.expenses) }}
                </span>
              </div>
              <div class="flex justify-between border-t-2 border-slate-300 py-3 text-xl font-bold dark:border-slate-600">
                <span class="text-slate-900 dark:text-slate-100">Net Profit</span>
