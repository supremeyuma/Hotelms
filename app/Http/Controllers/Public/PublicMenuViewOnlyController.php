...
class PublicMenuViewOnlyController extends Controller
{
    /**
     * Show the menu for walk-in customers (view only)
     * No ordering or payment functionality
     */
    public function index(Request $request, string $type = 'kitchen')
    {
        ...
        return Inertia::render('Public/MenuViewOnly', [
